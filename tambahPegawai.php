...
if (isset($_POST['tambah'])) {
    ...
    $tambah = mysqli_query($koneksi, "INSERT INTO tbl_user SET
    ...
    level='$_POST[level]'
     ");
    if ($tambah) {
        echo "<script> location.href='dataPegawai.php?pesan=tambah' </script>";
    }
}
?>
<!DOCTYPE html>
                        ...
                        <div class="box box-success">
                            ...
                            <div class="box-body">
                                <form action="" method="POST">
                                    ...
                                    <button name="tambah" type="submit" class="btn btn-success"><i class="fa  fa-pencil-square-o"></i> Simpan </button>
